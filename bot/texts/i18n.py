...
TEXTS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "WITHDRAW_INFO": (
            "Вывод Искр через Telegram Stars.\n"
            "Минимум: 500 Искр.\n"
            "Комиссия: 10% (для Premium — 0%).\n\n"
            "При заявке укажи реквизиты."
        ),
    ...
    "be": {
        ...
        "REG_RULES": (
            ...
            "<a href='{privacy}'>Палітыка канфідэнцыяльнасці</a>\n\n"
        ...
        "PREMIUM_TEXT": (
            ...
            "• AI-памочнік LUMA\n• Анкета вышэй у стужцы\n• Масавыя запрашэнні\n"
            "• Вывад Іскраў без камісіі\n• Бясплатны скід рэйтынгу раз на месяц\n"
            "• Зніжка 80% на прасоўванне тусовак"
        ),
        "WITHDRAW_INFO": "Вывад Іскраў праз Telegram Stars.\nМінімум: 500.\nКамісія: 10% (Premium — 0%).",
    ...
    "uk": {
        ...
        "PREMIUM_TEXT": (
            ...
            "• AI-помічник LUMA\n• Анкета вище у стрічці\n• Масові запрошення\n"
            "• Вивід Іскор без комісії\n• Безкоштовний скид рейтингу раз на місяць\n"
            "• Знижка 80% на просування тусовок"
        ),
        "WITHDRAW_INFO": "Вивід Іскор через Telegram Stars.\nМінімум: 500.\nКомісія: 10% (Premium — 0%).",
    ...
    "kk": {
        ...
        "PREMIUM_TEXT": (
            "Premium — жаңа деңгей:\n"
            "• AI-көмекші LUMA\n• Анкета жоғарыда\n• Жаппай шақырулар\n"
            "• Ұшқын шығару комиссиясыз\n• Ай сайын тегін рейтинг тастау\n"
            "• Тусовкаларды ілгерілетуге 80% жеңілдік"
        ),
        "WITHDRAW_INFO": "Ұшқынды Telegram Stars арқылы шығару.\nМинимум: 500.\nКомиссия: 10% (Premium — 0%).",
