...
TEXTS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "PREMIUM_TEXT": (
            ...
            "• Видео в анкете (можно вместе с несколькими фото)\n"
    ...
    "be": {
        ...
        "PREMIUM_TEXT": (
            ...
            "• Відэа ў анкеце (разам з некалькімі фота)\n"
    ...
    "uk": {
        ...
        "PREMIUM_TEXT": (
            ...
            "• Відео в анкеті (разом із кількома фото)\n"
    ...
    "kk": {
        ...
        "PREMIUM_TEXT": (
            ...
            "• Анкетада видео (бірнеше фотомен бірге)\n"
